"""
Django settings for floral_tree_45098 project.
...
ROOT_URLCONF = 'floral_tree_45098.urls'
...
WSGI_APPLICATION = 'floral_tree_45098.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_tree_45098 API",
    "DESCRIPTION": "API documentation for floral_tree_45098 App",
    "VERSION": "v1",
}
